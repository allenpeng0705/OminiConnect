...
pub extern "C" fn panda_on_request() -> i32 {
    set_header(b"x-omini-connect-policy", b"data-residency");
    RC_ALLOW
}
...
pub extern "C" fn panda_on_request_body(ptr: i32, len: i32) -> i32 {
    ...
    if !has_approved_dest && contains_chinese_pii(input) {
        set_header(b"x-omini-connect-blocked", b"data-residency");
        set_header(b"x-omini-connect-pii-type", b"chinese-national-id");
