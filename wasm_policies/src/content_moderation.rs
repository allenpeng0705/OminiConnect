...
pub extern "C" fn panda_on_request() -> i32 {
    set_header(b"x-omini-connect-policy", b"content-moderation");
    RC_ALLOW
}
...
pub extern "C" fn panda_on_request_body(ptr: i32, len: i32) -> i32 {
    ...
    match check_content(input) {
        ...
        _ => {
            set_header(b"x-omini-connect-blocked", b"content-moderation");
            set_header(b"x-omini-connect-content-category", category_name(check_content(input)));
