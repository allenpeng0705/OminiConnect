...
Provider: `sage-intacct` | Engine: `nango` | Auth: OAuth via Nango

## Overview

Sage Intacct is a cloud financial management platform. These tools allow AI agents to manage locations, departments, employees, projects, GL accounts, journals, and financial reports.

## Authentication

**Nango OAuth**:
- User authenticates via Nango Connect with Sage Intacct
...
|------|-------------|--------|----------|
| `sage-intacct_list_locations` | List all locations | GET | /v3/locations |
| `sage-intacct_get_location` | Get location details | GET | /v3/locations/{locationId} |
| `sage-intacct_list_departments` | List departments | GET | /v3/departments |
| `sage-intacct_list_employees` | List employees | GET | /v3/employees |
| `sage-intacct_get_employee` | Get employee details | GET | /v3/employees/{employeeId} |
| `sage-intacct_list_projects` | List projects | GET | /v3/projects |
| `sage-intacct_get_project` | Get project details | GET | /v3/projects/{projectId} |
| `sage-intacct_list_GL_accounts` | List GL accounts | GET | /v3/gl-accounts |
| `sage-intacct_list_journals` | List journal entries | GET | /v3/journals |
| `sage-intacct_get_reports` | Get financial reports | GET | /v3/reports |

---

## Tool Details

### sage-intacct_list_locations
...
- Locations and departments organize the company
- Projects track billing and time
- GL accounts form the chart of accounts
- Journals contain accounting transactions
- Reports provide financial statements
