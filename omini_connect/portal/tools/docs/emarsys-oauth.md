...
Provider: `emarsys-oauth` | Engine: `nango` | Auth: OAuth2 Client Credentials via Nango

## Overview

These tools wrap the Emarsys API using OAuth2 Client Credentials authentication. They allow AI agents to manage contacts, send campaigns, trigger events, and retrieve marketing analytics. Emarsys is a marketing automation platform for enterprise B2C brands.
...
- Same API endpoints as Emarsys WSSE

## Tool List

| Tool | Description | Method | Endpoint |
|------|-------------|--------|----------|
| `emarsys_oauth_get_settings` | Get account settings | GET | /api/v2/settings |
| `emarsys_oauth_list_contacts` | List contacts | GET | /api/v2/contacts |
| `emarsys_oauth_get_contact` | Get contact details | GET | /api/v2/contacts/{id} |
| `emarsys_oauth_create_contact` | Create a new contact | POST | /api/v2/contacts |
| `emarsys_oauth_update_contact` | Update contact details | PUT | /api/v2/contacts/{id} |
| `emarsys_oauth_list_campaigns` | List campaigns | GET | /api/v2/campaigns |
| `emarsys_oauth_get_campaign` | Get campaign details | GET | /api/v2/campaigns/{id} |
| `emarsys_oauth_trigger_event` | Trigger a contact event | POST | /api/v2/events |
| `emarsys_oauth_get_aggregate_report` | Get campaign aggregate report | GET | /api/v2/reports/campaigns/{id}/aggregate |
| `emarsys_oauth_list_segments` | List segments | GET | /api/v2/segments |

---

## Tool Details

### emarsys_oauth_get_settings
...
### emarsys_oauth_get_aggregate_report
...
- **OAuth2 CC**: Client credentials flow for server-to-server auth
