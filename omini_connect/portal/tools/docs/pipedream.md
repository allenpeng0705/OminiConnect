...
Provider: `pipedream` | Engine: `nango` | Auth: API Key via Nango

## Overview

These tools wrap the Pipedream API. They allow AI agents to manage event sources, workflows, API keys, events, and app connections. Pipedream is an automation and integration platform. **Requires Pipedream API Key authentication.**
...
|------|-------------|--------|----------|
| `pipedream_list_sources` | List event sources | GET | /v1/sources |
| `pipedream_get_source` | Get source details | GET | /v1/sources/{sourceId} |
| `pipedream_list_workflows` | List workflows | GET | /v1/workflows |
| `pipedream_get_workflow` | Get workflow details | GET | /v1/workflows/{workflowId} |
| `pipedream_list_keys` | List API keys | GET | /v1/keys |
| `pipedream_get_user` | Get user info | GET | /v1/users/me |
| `pipedream_list_events` | List events | GET | /v1/events |
| `pipedream_get_event` | Get event details | GET | /v1/events/{eventId} |
| `pipedream_list_connections` | List connections | GET | /v1/connections |
| `pipedream_get_account` | Get account info | GET | /v1/account |

---

## Tool Details

### pipedream_list_sources
