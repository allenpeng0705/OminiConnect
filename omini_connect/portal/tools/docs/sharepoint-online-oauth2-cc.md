# SharePoint Online (Client Credentials) Tools

Provider: `sharepoint-online-oauth2-cc` | Engine: `nango` | Auth: OAUTH2_CC

## Overview

These tools wrap the SharePoint Online (Client Credentials) API. They allow AI agents to interact with SharePoint Online (Client Credentials) functionality. **Requires OAUTH2_CC authentication.**
...
## SharePoint Online (Client Credentials) API Notes
