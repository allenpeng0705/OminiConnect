# Stripe App (Sandbox) Tools

Provider: `stripe-app-sandbox` | Engine: `nango` | Auth: OAUTH2

## Overview

These tools wrap the Stripe App (Sandbox) API. They allow AI agents to interact with Stripe App (Sandbox) functionality. **Requires OAUTH2 authentication.**
