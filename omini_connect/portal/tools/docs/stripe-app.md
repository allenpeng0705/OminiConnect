...
Provider: `stripe-app` | Engine: `nango` | Auth: OAUTH2

## Overview

These tools wrap the Stripe App API. They allow AI agents to interact with Stripe App functionality. **Requires OAUTH2 authentication.**
