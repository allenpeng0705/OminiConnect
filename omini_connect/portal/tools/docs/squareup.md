...
Provider: `squareup` | Engine: `nango` | Auth: OAUTH2

## Overview

These tools wrap the Squareup API. They allow AI agents to interact with Squareup functionality. **Requires OAUTH2 authentication.**
