...
Provider: `supabase-mcp` | Engine: `nango` | Auth: API_KEY

## Overview

These tools wrap the Supabase (MCP) API. They allow AI agents to interact with Supabase (MCP) functionality. **Requires API_KEY authentication.**
