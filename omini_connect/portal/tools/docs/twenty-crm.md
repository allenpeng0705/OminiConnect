...
Provider: `twenty-crm` | Engine: `nango` | Auth: API Key via Nango

## Overview

Twenty is an open-source CRM platform. **Requires api key via nango.**

## Authentication

**Nango API Key**:
- User provides their Twenty CRM API key
