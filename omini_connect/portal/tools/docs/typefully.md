...
Provider: `typefully` | Engine: `nango` | Auth: API Key via Nango

## Overview

Typefully is a writing tool for crafting tweets and threads. **Requires api key via nango.**

## Authentication

**Nango API Key**:
- User provides their Typefully API key
