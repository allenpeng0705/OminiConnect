# Jira Data Center API Key Tools

Provider: `jira-data-center-api-key` | Engine: `nango` | Auth: API_KEY via Nango

## Overview

These tools wrap the Jira Data Center API. They allow AI agents to manage projects, issues, and comments. **Requires Jira Data Center API key.**

## Authentication

**API Key via Nango**:
- User provides their Jira Data Center API key
- Token stored in Nango, accessed via `connection_ref`
- Base URL: Configured instance base URL

## Tool List

| Tool | Description | Method | Endpoint |
|------|-------------|--------|----------|
| `jira_data_center_api_key_get_current_user` | Get current user | GET | /rest/api/3/myself |
| `jira_data_center_api_key_list_projects` | List projects | GET | /rest/api/3/project |
| `jira_data_center_api_key_get_project` | Get project details | GET | /rest/api/3/project/{project_id_or_key} |
| `jira_data_center_api_key_list_issues` | List issues | GET | /rest/api/3/search |
| `jira_data_center_api_key_get_issue` | Get issue details | GET | /rest/api/3/issue/{issue_id_or_key} |
| `jira_data_center_api_key_create_issue` | Create an issue | POST | /rest/api/3/issue |
| `jira_data_center_api_key_update_issue` | Update an issue | PUT | /rest/api/3/issue/{issue_id_or_key} |
| `jira_data_center_api_key_list_comments` | List issue comments | GET | /rest/api/3/issue/{issue_id_or_key}/comment |
| `jira_data_center_api_key_add_comment` | Add a comment | POST | /rest/api/3/issue/{issue_id_or_key}/comment |
| `jira_data_center_api_key_search_issues` | Search issues | GET | /rest/api/3/search |

---

## Tool Details

### jira_data_center_api_key_get_current_user
...
### jira_data_center_api_key_list_projects
...
### jira_data_center_api_key_get_project
...
### jira_data_center_api_key_list_issues
...
### jira_data_center_api_key_get_issue
...
### jira_data_center_api_key_create_issue
...
### jira_data_center_api_key_update_issue
...
### jira_data_center_api_key_list_comments
...
### jira_data_center_api_key_add_comment
...
### jira_data_center_api_key_search_issues
...
## Jira Data Center API Key Notes
