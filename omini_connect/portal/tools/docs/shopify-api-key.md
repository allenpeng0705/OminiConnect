# Shopify (API Key) Tools

Provider: `shopify-api-key` | Engine: `nango` | Auth: API_KEY

## Overview

These tools wrap the Shopify (API Key) API. They allow AI agents to interact with Shopify (API Key) functionality. **Requires API_KEY authentication.**
...
## Shopify (API Key) API Notes

- **Auth mode**: API_KEY
- **Base URL**: https://{subdomain}.myshopify.com
- **API prefix**: /admin/api/2024-10
