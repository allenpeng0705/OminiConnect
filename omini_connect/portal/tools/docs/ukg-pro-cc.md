# UKG Pro (OAuth2 CC) Tools

Provider: `ukg-pro-cc` | Engine: `nango` | Auth: OAuth2 Client Credentials via Nango

## Overview

UKG Pro with OAuth2 Client Credentials authentication. **Requires oauth2 client credentials via nango.**
...
- Docs: https://nango.dev/docs/integrations/all/ukg-pro-cc
