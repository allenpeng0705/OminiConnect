...
Provider: `paycor` | Engine: `nango` | Auth: OAuth2 via Nango

## Overview

These tools wrap the Paycor API. They allow AI agents to manage employees, payroll runs, time entries, departments, jobs, benefits, and pay groups. **Requires Paycor OAuth2 authentication.**

## Authentication

**Nango OAuth2**:
- User authenticates via Nango Connect with Paycor
- Token stored in Nango, accessed via `connection_ref`
- Base URL: https://apis.paycor.com
...
|------|-------------|--------|----------|
| `paycor_list_employees` | List employees | GET | /v1/employees |
| `paycor_get_employee` | Get employee details | GET | /v1/employees/{employeeId} |
| `paycor_list_payroll_runs` | List payroll runs | GET | /v1/payroll/runs |
| `paycor_get_payroll_run` | Get payroll run details | GET | /v1/payroll/runs/{runId} |
| `paycor_list_time_entries` | List time entries | GET | /v1/time/entries |
| `paycor_list_departments` | List departments | GET | /v1/departments |
| `paycor_list_jobs` | List jobs/positions | GET | /v1/jobs |
| `paycor_list_benefits` | List benefit plans | GET | /v1/benefits |
| `paycor_list_pay_groups` | List pay groups | GET | /v1/pay-groups |
| `paycor_get_company_info` | Get company information | GET | /v1/company |

---

## Tool Details

### paycor_list_employees
