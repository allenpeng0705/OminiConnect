//! # OmniConnect Developer SDK
//!
//! Rust SDK for building applications on OmniConnect.
//!
//! ## Features
//!
//! - **Client** - Connect to OmniConnect MCP servers
...
//!
//! ```rust,ignore
//! use omni_sdk::{Client, Config};
//!
//! // Load configuration from file
//! let config = Config::from_file("omni_connect.yaml")?;
