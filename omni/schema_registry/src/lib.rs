//! # OmniConnect Schema Registry
//!
//! Centralized tool schema registry for OmniConnect MCP connectors.
...
//!
//! ```rust
//! use omni_schema_registry::{SchemaRegistry, Platform, Category, ToolFilter};
//!
