# Paylocity NextGen Tools

Provider: `paylocity-nextgen` | Engine: `nango` | Auth: OAuth2 Client Credentials via Nango

## Overview

These tools wrap the Paylocity NextGen API. They allow AI agents to manage employees, payroll runs, time entries, departments, jobs, benefits, and pay groups. **Requires Paylocity NextGen OAuth2 Client Credentials authentication.**
...
|------|-------------|--------|----------|
| `paylocity_nextgen_list_employees` | List employees | GET | /v1/employees |
| `paylocity_nextgen_get_employee` | Get employee details | GET | /v1/employees/{employeeId} |
| `paylocity_nextgen_list_payroll_runs` | List payroll runs | GET | /v1/payroll/runs |
| `paylocity_nextgen_get_payroll_run` | Get payroll run details | GET | /v1/payroll/runs/{runId} |
| `paylocity_nextgen_list_time_entries` | List time entries | GET | /v1/time/entries |
| `paylocity_nextgen_list_departments` | List departments | GET | /v1/departments |
| `paylocity_nextgen_list_jobs` | List jobs/positions | GET | /v1/jobs |
| `paylocity_nextgen_list_benefits` | List benefit plans | GET | /v1/benefits |
| `paylocity_nextgen_list_pay_groups` | List pay groups | GET | /v1/pay-groups |
| `paylocity_nextgen_get_company_info` | Get company information | GET | /v1/company |

---

## Tool Details

### paylocity_nextgen_list_employees
...
### paylocity_nextgen_get_employee
...
### paylocity_nextgen_list_payroll_runs
...
### paylocity_nextgen_get_payroll_run
...
### paylocity_nextgen_list_time_entries
...
### paylocity_nextgen_list_departments
...
### paylocity_nextgen_list_benefits
...
### paylocity_nextgen_list_pay_groups
...
### paylocity_nextgen_get_company_info
