...
Provider: `greenhouse-harvest` | Engine: `nango` | Auth: Basic Auth via Nango

## Overview

These tools wrap the Greenhouse Harvest API. They allow AI agents to manage candidates, jobs, applications, and offers. Greenhouse Harvest provides core ATS functionality.
...
- **Departments**: Organizational units for jobs
- **Rejection reasons**: Configured reasons for rejecting applications
