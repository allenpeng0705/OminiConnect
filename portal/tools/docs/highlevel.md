...
Provider: `highlevel` | Engine: `nango` | Auth: OAuth2 via Nango

## Overview

These tools wrap the HighLevel API. They allow AI agents to manage contacts, opportunities, tasks, appointments, and campaigns. HighLevel is a CRM and marketing automation platform.

## Authentication

**Nango OAuth2**:
- User authenticates via Nango Connect with HighLevel
...
**What it does**: Lists all contacts in HighLevel.
...
**What it does**: Lists all opportunities in HighLevel.
...
**What it does**: Lists all tasks in HighLevel.
...
**What it does**: Lists all appointments in HighLevel.
...
**What it does**: Lists all campaigns in HighLevel.
...
**What it does**: Lists all forms in HighLevel.
