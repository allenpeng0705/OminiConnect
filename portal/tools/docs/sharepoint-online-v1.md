# SharePoint Online (v1) Tools

Provider: `sharepoint-online-v1` | Engine: `nango` | Auth: TWO_STEP

## Overview

These tools wrap the SharePoint Online (v1) API. They allow AI agents to interact with SharePoint Online (v1) functionality. **Requires TWO_STEP authentication.**
...
## SharePoint Online (v1) API Notes

- **Auth mode**: TWO_STEP
- **Base URL**: https://{tenantName}.sharepoint.com
- **API prefix**: /
