# Workable (OAuth) Tools

Provider: `workable-oauth` | Engine: `nango` | Auth: OAuth2 via Nango

## Overview

Workable is an applicant tracking system for recruiting (OAuth). **Requires oauth2 via nango.**

## Authentication

**Nango OAuth**:
- User authenticates via Nango Connect with Workable (OAuth)
