# Thrivecart (API Key) Tools

Provider: `thrivecart-api-key` | Engine: `nango` | Auth: API Key via Nango

## Overview

Thrivecart is an e-commerce platform for selling products and services. **Requires api key via nango.**

## Authentication

**Nango API Key**:
- User provides their Thrivecart (API Key) API key
