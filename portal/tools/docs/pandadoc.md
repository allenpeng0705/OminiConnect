...
Provider: `pandadoc` | Engine: `nango` | Auth: OAuth via Nango

## Overview

These tools wrap the Pandadoc API for document management and e-signatures. They allow AI agents to manage documents, templates, folders, and track document analytics. **Requires Pandadoc OAuth authentication.**

## Authentication

**OAuth2**:
- User authenticates via Nango Connect with Pandadoc
...
- **Analytics**: Views, time spent, engagement
- **Folders**: Organize documents by project/type
