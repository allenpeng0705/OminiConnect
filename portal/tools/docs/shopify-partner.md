...
Provider: `shopify-partner` | Engine: `nango` | Auth: API_KEY

## Overview

These tools wrap the Shopify Partner API. They allow AI agents to interact with Shopify Partner functionality. **Requires API_KEY authentication.**
...
## Shopify Partner API Notes

- **Auth mode**: API_KEY
- **Base URL**: https://partners.shopify.com/{partnerId}/api
- **API prefix**: /2025-04
