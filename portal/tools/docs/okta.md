...
Provider: `okta` | Engine: `nango` | Auth: OAuth via Nango

## Overview

These tools wrap the Okta API for identity and access management. They allow AI agents to manage users, groups, applications, and view audit logs. **Requires Okta OAuth authentication.**

## Authentication

**OAuth2**:
- User authenticates via Nango Connect with Okta
- Authorization URL: `https://{subdomain}.okta.com/oauth2/v1/authorize`
