# Jira Basic Auth Tools

Provider: `jira-basic` | Engine: `nango` | Auth: BASIC via Nango

## Overview

These tools wrap the Jira API v3. They allow AI agents to manage projects, issues, and comments. **Requires Jira account with Basic Auth (email + API key).**

## Authentication

**Basic Auth via Nango**:
- User provides email and API key
- Token stored in Nango, accessed via `connection_ref`
- Base URL: `https://{subdomain}.atlassian.net`

## Tool List

| Tool | Description | Method | Endpoint |
|------|-------------|--------|----------|
| `jira_get_current_user` | Get current user | GET | /rest/api/3/myself |
| `jira_list_projects` | List projects | GET | /rest/api/3/project |
| `jira_get_project` | Get project details | GET | /rest/api/3/project/{project_id_or_key} |
| `jira_list_issues` | List issues | GET | /rest/api/3/search |
| `jira_get_issue` | Get issue details | GET | /rest/api/3/issue/{issue_id_or_key} |
| `jira_create_issue` | Create an issue | POST | /rest/api/3/issue |
| `jira_update_issue` | Update an issue | PUT | /rest/api/3/issue/{issue_id_or_key} |
| `jira_list_comments` | List issue comments | GET | /rest/api/3/issue/{issue_id_or_key}/comment |
| `jira_add_comment` | Add a comment | POST | /rest/api/3/issue/{issue_id_or_key}/comment |
| `jira_search_issues` | Search issues | GET | /rest/api/3/search |
...
- **API Rate Limits**: Apply to API calls - implement backoff for heavy use
- **Cloud only**: This is for Jira Cloud, not Data Center
