...
Provider: `ninjaone-rmm-oauth2` | Engine: `nango` | Auth: OAuth2 Authorization Code via Nango

## Overview

These tools wrap the NinjaOne RMM API. They allow AI agents to manage devices, monitor alerts, run automation scripts, and view dashboard information. **Requires NinjaOne OAuth2 Authorization Code authentication.**

## Authentication

**OAuth2 Authorization Code**:
- User authenticates via Nango Connect with NinjaOne
- Uses OAuth2 authorization code flow
- Supports refresh tokens for extended access
...
## NinjaOne RMM OAuth2 Notes

- **OAuth2 Auth Code**: Uses authorization code flow for user authentication
- **Refresh tokens**: Supports offline access via refresh tokens
