...
Provider: `pingone` | Engine: `nango` | Auth: OAuth2 via Nango

## Overview

These tools wrap the PingOne API. They allow AI agents to manage users, groups, applications, populations, and audit events. PingOne is an identity and access management platform. **Requires PingOne OAuth2 authentication.**

## Authentication

**Nango OAuth2**:
- User authenticates via Nango Connect with PingOne
- Token stored in Nango, accessed via `connection_ref`
- Base URL: https://api.pingone.{tld}
- Requires tld and environmentId in connection config

## Tool List

| Tool | Description | Method | Endpoint |
|------|-------------|--------|----------|
| `pingone_list_users` | List users | GET | /v1/users |
| `pingone_get_user` | Get user details | GET | /v1/users/{userId} |
| `pingone_list_groups` | List groups | GET | /v1/groups |
| `pingone_get_group` | Get group details | GET | /v1/groups/{groupId} |
| `pingone_list_applications` | List applications | GET | /v1/applications |
| `pingone_get_application` | Get application details | GET | /v1/applications/{applicationId} |
| `pingone_list_populations` | List populations | GET | /v1/populations |
| `pingone_get_population` | Get population details | GET | /v1/populations/{populationId} |
| `pingone_list_events` | List audit events | GET | /v1/events |
| `pingone_get_environment` | Get environment info | GET | /v1/environments/{environmentId} |
