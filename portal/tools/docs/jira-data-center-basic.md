# Jira Data Center Basic Auth Tools

Provider: `jira-data-center-basic` | Engine: `nango` | Auth: BASIC via Nango

## Overview

These tools wrap the Jira Data Center API. They allow AI agents to manage projects, issues, and comments. **Requires Jira Data Center username and password.**
...
|------|-------------|--------|----------|
| `jira_data_center_basic_get_current_user` | Get current user | GET | /rest/api/3/myself |
| `jira_data_center_basic_list_projects` | List projects | GET | /rest/api/3/project |
| `jira_data_center_basic_get_project` | Get project details | GET | /rest/api/3/project/{project_id_or_key} |
| `jira_data_center_basic_list_issues` | List issues | GET | /rest/api/3/search |
| `jira_data_center_basic_get_issue` | Get issue details | GET | /rest/api/3/issue/{issue_id_or_key} |
| `jira_data_center_basic_create_issue` | Create an issue | POST | /rest/api/3/issue |
| `jira_data_center_basic_update_issue` | Update an issue | PUT | /rest/api/3/issue/{issue_id_or_key} |
| `jira_data_center_basic_list_comments` | List issue comments | GET | /rest/api/3/issue/{issue_id_or_key}/comment |
| `jira_data_center_basic_add_comment` | Add a comment | POST | /rest/api/3/issue/{issue_id_or_key}/comment |
| `jira_data_center_basic_search_issues` | Search issues | GET | /rest/api/3/search |

---

## Tool Details

### jira_data_center_basic_get_current_user
...
### jira_data_center_basic_list_projects
...
### jira_data_center_basic_get_project
...
### jira_data_center_basic_list_issues
...
### jira_data_center_basic_get_issue
...
### jira_data_center_basic_create_issue
...
### jira_data_center_basic_update_issue
...
### jira_data_center_basic_list_comments
...
### jira_data_center_basic_add_comment
...
### jira_data_center_basic_search_issues
...
## Jira Data Center Basic Auth Notes
