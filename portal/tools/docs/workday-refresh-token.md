# Workday (Refresh Token) Tools

Provider: `workday-refresh-token` | Engine: `nango` | Auth: Two-Step OAuth via Nango

## Overview

Workday with refresh token authentication. **Requires two-step oauth via nango.**
...
- Docs: https://nango.dev/docs/integrations/all/workday-refresh-token
