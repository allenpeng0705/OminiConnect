...
Provider: `namely` | Engine: `nango` | Auth: OAuth via Nango

## Overview

These tools wrap the Namely HR platform API. They allow AI agents to manage employees, departments, job postings, time off requests, benefits, and payroll. **Requires Namely OAuth access.**

## Authentication

**Nango OAuth**:
- User authenticates via Nango Connect with Namely
- Token stored in Nango, accessed via `connection_ref`
- Required scopes depend on the specific tool being used
