...
Provider: `netsuite` | Engine: `nango` | Auth: OAuth via Nango

## Overview

These tools wrap the NetSuite SuiteTalks REST API. They allow AI agents to manage customers, invoices, items, vendors, purchase orders, employees, and departments. **Requires NetSuite OAuth access.**

## Authentication

**Nango OAuth**:
- User authenticates via Nango Connect with NetSuite
- Token stored in Nango, accessed via `connection_ref`
- Required scope: `rest_webservices`
...
- **Retry headers**: Respects `retry-after` header
