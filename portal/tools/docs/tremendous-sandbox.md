# Tremendous (Sandbox) Tools

Provider: `tremendous-sandbox` | Engine: `nango` | Auth: OAuth2 via Nango

## Overview

Tremendous sandbox environment for testing. **Requires oauth2 via nango.**

## Authentication

**Nango OAuth**:
- User authenticates via Nango Connect with Tremendous (Sandbox)
