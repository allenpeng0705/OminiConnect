...
Provider: `blackbaud` | Engine: `nango` | Auth: OAuth2 via Nango

## Overview

These tools wrap the Blackbaud SKY API. They allow AI agents to manage constituents (donors), gifts, campaigns, funds, and appeals for nonprofit fundraising and CRM. Blackbaud is a provider of software and services for nonprofits.

## Authentication

**Nango OAuth2**:
- User authenticates via Blackbaud OAuth
...
|------|-------------|--------|----------|
| `blackbaud_list_constituents` | List constituents | GET | /constituents/v1/constituents |
| `blackbaud_get_constituent` | Get constituent details | GET | /constituents/v1/constituents/{id} |
| `blackbaud_list_gifts` | List gifts | GET | /gift/v1/gifts |
| `blackbaud_get_gift` | Get gift details | GET | /gift/v1/gifts/{id} |
| `blackbaud_list_campaigns` | List campaigns | GET | /campaign/v1/campaigns |
| `blackbaud_get_campaign` | Get campaign details | GET | /campaign/v1/campaigns/{id} |
| `blackbaud_list_funds` | List funds | GET | /fund/v1/funds |
| `blackbaud_get_fund` | Get fund details | GET | /fund/v1/funds/{id} |
| `blackbaud_list_appeals` | List appeals | GET | /appeal/v1/appeals |
| `blackbaud_get_appeal` | Get appeal details | GET | /appeal/v1/appeals/{id} |

---

## Tool Details

### blackbaud_list_constituents
...
**Example LLM prompt**: "List all constituents in Blackbaud"

---

### blackbaud_get_constituent
...
- **Campaigns**: Container for fundraising goals
- **Funds**: Designations for where donations go
- **Appeals**: Specific fundraising requests/messages
