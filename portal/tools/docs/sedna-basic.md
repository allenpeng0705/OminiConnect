# Sedna (Basic Auth) Tools

Provider: `sedna-basic` | Engine: `nango` | Auth: BASIC

## Overview

These tools wrap the Sedna (Basic Auth) API. They allow AI agents to interact with Sedna (Basic Auth) functionality. **Requires BASIC authentication.**
