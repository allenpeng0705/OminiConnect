# Lever Sandbox OAuth Tools

Provider: `lever-sandbox` | Engine: `nango` | Auth: OAuth2 via Nango (Sandbox)

## Overview

These tools wrap the Lever Sandbox API. They allow AI agents to manage opportunities, offers, jobs, and hiring workflows in a testing environment. **Requires Lever Sandbox OAuth2 authentication.**

## Authentication

**OAuth2 via Nango**:
- User authenticates via Nango Connect with Lever Sandbox
...
|------|-------------|--------|----------|
| `lever_sandbox_list_opportunities` | List opportunities | GET | /v1/opportunities |
| `lever_sandbox_get_opportunity` | Get opportunity details | GET | /v1/opportunities/{opportunity_id} |
| `lever_sandbox_list_offers` | List offers | GET | /v1/offers |
| `lever_sandbox_get_offer` | Get offer details | GET | /v1/offers/{offer_id} |
| `lever_sandbox_list_users` | List users | GET | /v1/users |
| `lever_sandbox_get_user` | Get user details | GET | /v1/users/{user_id} |
| `lever_sandbox_list_jobs` | List jobs | GET | /v1/jobs |
| `lever_sandbox_get_job` | Get job details | GET | /v1/jobs/{job_id} |
| `lever_sandbox_list_stages` | List stages | GET | /v1/stages |
| `lever_sandbox_list_notes` | List notes | GET | /v1/notes |

---

## Tool Details

### lever_sandbox_list_opportunities
