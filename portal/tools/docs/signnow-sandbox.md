# SignNow (Sandbox) Tools

Provider: `signnow-sandbox` | Engine: `nango` | Auth: OAUTH2

## Overview

These tools wrap the SignNow (Sandbox) API. They allow AI agents to interact with SignNow (Sandbox) functionality. **Requires OAUTH2 authentication.**
...
## SignNow (Sandbox) API Notes

- **Auth mode**: OAUTH2
- **Base URL**: https://api-eval.signnow.com
- **API prefix**: /
