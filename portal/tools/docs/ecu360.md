...
Provider: `ecu360` | Engine: `nango` | Auth: Two-Step via Nango (Test Environment)

## Overview

These tools wrap the ECU360 API (Test environment). They allow AI agents to manage products, orders, customers, inventory, and shipments. ECU360 is an e-commerce and supply chain management platform.
...
- Uses test environment (apim-test.ecu360.com)

## Tool List

| Tool | Description | Method | Endpoint |
|------|-------------|--------|----------|
| `ecu360_list_products` | List products | GET | /products |
| `ecu360_get_product` | Get product details | GET | /products/{product_id} |
| `ecu360_list_orders` | List orders | GET | /orders |
| `ecu360_get_order` | Get order details | GET | /orders/{order_id} |
| `ecu360_list_customers` | List customers | GET | /customers |
| `ecu360_get_customer` | Get customer details | GET | /customers/{customer_id} |
| `ecu360_list_inventories` | List inventory | GET | /inventory |
| `ecu360_get_inventory` | Get inventory details | GET | /inventory/{inventory_id} |
| `ecu360_list_shipments` | List shipments | GET | /shipments |
| `ecu360_get_shipment` | Get shipment details | GET | /shipments/{shipment_id} |

---

## Tool Details

### ecu360_list_products
...
**What it does**: Lists all orders with optional status filtering.
...
- **Test Environment**: This uses the test API endpoint (apim-test.ecu360.com)
- **Production Variant**: ecu360-production uses the production endpoint
