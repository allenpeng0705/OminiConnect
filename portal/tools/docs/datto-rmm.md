...
Provider: `datto-rmm` | Engine: `nango` | Auth: OAuth via Nango

## Overview

These tools wrap the Datto RMM API. They allow AI agents to manage devices, alerts, policies, users, and tickets. Datto RMM is a remote monitoring and management platform for MSPs.

## Authentication

**Nango OAuth**:
- User authenticates via Nango Connect with Datto RMM
...
|------|-------------|--------|----------|
| `datto_rmm_list_devices` | List devices | GET | /devices |
| `datto_rmm_get_device` | Get device details | GET | /devices/{deviceUid} |
| `datto_rmm_list_alerts` | List alerts | GET | /alerts |
| `datto_rmm_get_alert` | Get alert details | GET | /alerts/{alertId} |
| `datto_rmm_list_policies` | List policies | GET | /policies |
| `datto_rmm_get_policy` | Get policy details | GET | /policies/{policyId} |
| `datto_rmm_list_users` | List users | GET | /users |
| `datto_rmm_get_user` | Get user details | GET | /users/{userId} |
| `datto_rmm_list_tickets` | List tickets | GET | /tickets |
| `datto_rmm_get_ticket` | Get ticket details | GET | /tickets/{ticketId} |

---

## Tool Details

### datto_rmm_list_devices
...
### datto_rmm_get_device

**What it does**: Gets detailed device information including status and agent version.
...
- **RMM**: Remote Monitoring and Management platform for MSPs
...
- **Platform**: Region-specific API endpoints (pinotage, merlot, concord, vidal, zinfandel, syrah)
