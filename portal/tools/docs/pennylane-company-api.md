# Pennylane Company API Tools

Provider: `pennylane-company-api` | Engine: `nango` | Auth: API Key via Nango

## Overview

These tools wrap the Pennylane Company API. They allow AI agents to manage accounts, contacts, invoices, expenses, and items. Pennylane is an accounting and invoicing platform. **Requires Pennylane API Key authentication.**
...
|------|-------------|--------|----------|
| `pennylane_company_list_accounts` | List accounts | GET | /api/v1/accounts |
| `pennylane_company_get_account` | Get account details | GET | /api/v1/accounts/{accountId} |
| `pennylane_company_list_contacts` | List contacts | GET | /api/v1/contacts |
| `pennylane_company_get_contact` | Get contact details | GET | /api/v1/contacts/{contactId} |
| `pennylane_company_list_invoices` | List invoices | GET | /api/v1/invoices |
| `pennylane_company_get_invoice` | Get invoice details | GET | /api/v1/invoices/{invoiceId} |
| `pennylane_company_list_expenses` | List expenses | GET | /api/v1/expenses |
| `pennylane_company_get_expense` | Get expense details | GET | /api/v1/expenses/{expenseId} |
| `pennylane_company_list_items` | List items/products | GET | /api/v1/items |
| `pennylane_company_get_company_info` | Get company information | GET | /api/v1/company |

---

## Tool Details

### pennylane_company_list_accounts
...
### pennylane_company_list_contacts
...
### pennylane_company_list_invoices
...
### pennylane_company_list_expenses
...
### pennylane_company_get_company_info
